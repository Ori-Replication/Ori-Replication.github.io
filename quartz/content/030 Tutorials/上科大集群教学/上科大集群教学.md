...
3. partition代表你的队列。比如我这个账号只有normal的权限。具体能够申请到哪些节点，可以通过集群手册去看。比如我是normal队列，能够使用的GPU是 ai_gpu14~25，sist_gpu36~66，最多能够申请的GPU是12块。但这里测试了一下，能够使用的GPU变成了 ai_gpu 18~25, sist_gpu 36~70.这一点集群手册没有更新。因为 14-17这几个节点换了最新的L20显卡，没有开放给normal用户用。![[Pasted image 20250222200644.png]]
